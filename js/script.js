...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 2. Fancybox load karein
    initFancybox();

    // 3. Work Filter karein
    filterWork('social');

    // 4. 🔥 CRITICAL FIX: Content load hone ke baad AOS ko refresh karein
    // Isse form second refresh ka wait nahi karega
    setTimeout(() => {
        AOS.refresh();
    }, 500); 
});

// Agar aap window load use karte hain toh ye aur bhi zyada stable hai
...
/* ==========================================
   4. WHATSAPP CONTACT FORM LOGIC with dropdown
   ========================================== */
